      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 glass-card-featured accent-top-card p-8 space-y-7">
          ...
          <div className="flex items-center justify-between p-5 bg-card/50 rounded-2xl border border-border/20">
            <div className="flex items-center gap-4">
              <div
                className={`w-12 h-12 rounded-xl flex items-center justify-center border ${open ? "bg-success/10 border-success/15" : "bg-destructive/10 border-destructive/15"}`}
              >
                {open ? (
                  <Unlock size={22} className="text-success" />
                ) : (
              ...
              <div>
                ...
                <div className="text-xs text-muted-foreground mt-0.5">
                  Currently {open ? "accepting" : "blocking"} new applications
                </div>
              </div>
            </div>
            <button
            ...
            >
              <span
                className={`absolute top-1 w-6 h-6 bg-foreground rounded-full transition-transform duration-300 shadow-lg ${open ? "left-9" : "left-1"}`}
              />
            </button>
          </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="glass-input pl-11 text-lg font-bold"
                />
              </div>
            </div>
            <div>
          ...
          <div className="bg-info/4 border border-info/12 rounded-2xl p-5 text-sm text-muted-foreground flex gap-3">
            ...
            <p>
              Agents can apply between{" "}
              <strong className="text-foreground">day {startDay}</strong> and{" "}
              <strong className="text-foreground">day {endDay}</strong> of each
              month. Currently{" "}
              <strong className={open ? "text-success" : "text-destructive"}>
                {open ? "open" : "closed"}
              </strong>
              .
            </p>
        ...
        <div className="space-y-4">
          <div className="glass-card gradient-border p-6 text-center">
            <div
              className={`w-16 h-16 rounded-2xl mx-auto mb-4 flex items-center justify-center border ${open ? "bg-success/8 border-success/12" : "bg-destructive/8 border-destructive/12"}`}
            >
              <Shield
                size={28}
                className={open ? "text-success" : "text-destructive"}
              />
            </div>
          ...
          <div className="glass-card p-5">
            <h3 className="text-xs font-bold font-heading mb-3 flex items-center gap-2">
              <Clock size={13} className="text-accent" /> Window Range
            </h3>
            <div className="flex items-center justify-center gap-4 py-3">
              <div className="text-center">
                ...
                <div className="text-[9px] text-muted-foreground tracking-section uppercase">
                  Start
                </div>
              </div>
            ...
            <div className="text-center text-[10px] text-muted-foreground mt-2">
              {endDay - startDay + 1} days each month
            </div>
          </div>
        </div>
      </div>
