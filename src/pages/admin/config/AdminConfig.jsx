          ...
          <div className="bg-card border border-border rounded-xl p-7 space-y-6 max-w-4xl">
            ...
            <div className="flex items-center justify-between p-4 bg-muted/20 rounded-xl border border-border">
              <div className="flex items-center gap-3">
                <div
                  className={`w-10 h-10 rounded-xl flex items-center justify-center border ${open ? "bg-success/10 border-success/20" : "bg-destructive/10 border-destructive/20"}`}
                >
                  {open ? (
                ...
                <div>
                  ...
                  <div className="text-xs text-muted-foreground">
                    Currently {open ? "accepting" : "blocking"} applications
                  </div>
                </div>
              </div>
              <button
              ...
              >
                <span
                  className={`absolute top-1 w-5 h-5 bg-white rounded-full transition-transform duration-300 shadow ${open ? "left-8" : "left-1"}`}
                />
              </button>
            </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="glass-input pl-9 text-base font-bold"
                  />
                </div>
              </div>
              <div>
            ...
            <div className="bg-info/5 border border-info/15 rounded-xl p-4 text-xs text-muted-foreground flex gap-2.5">
              ...
              <p>
                ...
                <strong className="text-foreground">day {endDay}</strong> of
            ...
            <button
              ...
              className="w-full btn-primary-gradient font-bold py-3 rounded-xl disabled:opacity-50 text-sm"
            >
          ...
          <div className="bg-card border border-border rounded-xl p-7 max-w-4xl">
            ...
            <div className="grid grid-cols-3 gap-4 mb-6">
              ...
              <div className="bg-muted/30 border border-border rounded-lg p-4">
                <label className="block text-xs font-semibold mb-2 uppercase tracking-section text-muted-foreground">
                  Daily Cap (%)
                </label>
                <div className="relative">
                  <BarChart3
                    size={12}
                    className="absolute left-2.5 top-1/2 -translate-y-1/2 text-primary"
                  />
                  <input
                    type="number"
                    min={0}
              ...
              <div className="bg-muted/30 border border-border rounded-lg p-4">
                ...
                <div className="relative">
                  <Users
                    size={12}
                    className="absolute left-2.5 top-1/2 -translate-y-1/2 text-info"
                  />
                  <input
                    type="number"
                    min={0}
                    ...
                    onChange={(e) =>
                      setAgentMonthlyLeaveCap(Number(e.target.value))
                    }
                    className="glass-input pl-7 text-lg font-bold w-full"
                  />
                </div>
            ...
            <div className="bg-warning/5 border border-warning/15 rounded-xl p-4 text-xs text-muted-foreground flex gap-2.5 mb-6">
              ...
              <p>
                ...
                blocked dates and shrinkage calculations.
              </p>
            </div>
