  ...
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "radial-gradient(circle at 1px 1px, hsla(225,12%,30%,0.15) 1px, transparent 0)",
          backgroundSize: "48px 48px",
        }}
      />
      {/* Gradient overlays */}
      <div
        className="absolute top-0 left-1/4 w-[600px] h-[600px] rounded-full blur-[120px] animate-float"
        style={{
          background:
      ...
      />
      <div
        className="absolute bottom-0 right-1/4 w-[500px] h-[500px] rounded-full blur-[100px] animate-float-delayed"
        style={{
          background:
            "radial-gradient(circle, hsla(35,100%,60%,0.06) 0%, transparent 70%)",
        }}
      />
      <div
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] rounded-full blur-[140px] animate-float-slow"
        style={{
          background:
            "radial-gradient(circle, hsla(215,100%,58%,0.04) 0%, transparent 70%)",
        }}
      />
      {/* Animated lines */}
      <svg
...
const featureAccentMap = {
  primary: {
    ...
    borderGlow:
      "hover:border-primary/20 hover:shadow-[0_0_60px_hsla(354,100%,64%,0.08)]",
  },
  accent: {
    iconBg: "bg-accent/10",
    ...
    borderGlow:
      "hover:border-accent/20 hover:shadow-[0_0_60px_hsla(35,100%,60%,0.08)]",
  },
  info: {
    iconBg: "bg-info/10",
    iconColor: "text-info",
    ...
    borderGlow:
      "hover:border-info/20 hover:shadow-[0_0_60px_hsla(215,100%,58%,0.08)]",
  },
};
...
const roleAccentMap = {
  primary: {
    ...
    glow: "hover:shadow-[0_20px_60px_hsla(354,100%,64%,0.1)]",
  },
  accent: {
    bg: "bg-accent/8",
    text: "text-accent",
    border: "border-accent/15",
    glow: "hover:shadow-[0_20px_60px_hsla(35,100%,60%,0.1)]",
  },
  manager: {
    bg: "bg-success/8",
    text: "text-success",
    border: "border-success/15",
    glow: "hover:shadow-[0_20px_60px_hsla(152,69%,42%,0.1)]",
  },
  info: {
    bg: "bg-info/8",
    text: "text-info",
    border: "border-info/15",
    glow: "hover:shadow-[0_20px_60px_hsla(215,100%,58%,0.1)]",
  },
};
    ...
    <div className="min-h-screen bg-background overflow-hidden relative">
      ...
      <nav className="relative z-20 flex items-center justify-between px-6 lg:px-16 xl:px-24 py-5">
        <div className="flex items-center gap-3">
          <div
            className="w-12 h-12 rounded-2xl bg-gradient-to-br from-primary/25 to-accent/15 flex items-center justify-center border border-primary/15 relative"
            style={{ boxShadow: "0 0 40px hsla(354,100%,64%,0.12)" }}
          >
            <span className="text-xl font-black gradient-text font-heading">
              L
            </span>
          ...
          <div>
            <span className="text-xl font-black tracking-heading font-heading">
              LSM
            </span>
            <span className="hidden sm:inline text-[11px] text-muted-foreground/60 ml-3 font-medium tracking-wide">
              Leave & Shrinkage Manager
            </span>
          </div>
        </div>
        <div className="flex items-center gap-3">
          <Link
            to="/login"
            className="text-sm font-semibold text-muted-foreground hover:text-foreground transition-colors px-5 py-2.5 rounded-xl hover:bg-secondary/40"
          >
            Sign In
          </Link>
          <Link
            to="/login"
            className="btn-primary-gradient text-primary-foreground font-bold text-sm px-7 py-3 rounded-2xl flex items-center gap-2 group"
          >
            Get Started{" "}
            <ArrowRight
              size={14}
      ...
      <section
        ref={heroRef}
        className="relative z-10 px-6 lg:px-16 xl:px-24 pb-20  lg:pb-20 max-w-[1400px] mx-auto"
      >
        <motion.div
        ...
        >
          ...
          >
            Streamline <span className="gradient-text">Leave</span>
          ...
          >
            Empower guides, supervisors, managers, and admins with intelligent
            leave scheduling, real-time shrinkage analytics, and automated
            approval workflows built for modern contact centers.
          </motion.p>
          ...
          >
            <Link
              to="/login"
              className="btn-primary-gradient text-primary-foreground font-bold px-10 py-3.5 rounded-2xl text-sm flex items-center gap-2.5 group shadow-2xl shadow-primary/25"
            >
              Launch Dashboard
              <ArrowRight
                size={18}
            ...
            <a
              href="#features"
              className="bg-card/60 backdrop-blur-xl border border-border/60 text-foreground font-semibold px-8 py-3 rounded-2xl text-sm flex items-center gap-2 hover:bg-card/80 hover:border-border transition-all group"
            >
              <Globe
                size={16}
          ...
          >
            <div className="flex -space-x-3">
              {["SC", "JO", "PM", "AK"].map((initials, i) => (
                <div
                  key={i}
                  className="w-9 h-9 rounded-full bg-gradient-to-br from-primary/20 to-accent/10 border-2 border-background flex items-center justify-center"
                >
          ...
          <div className="relative grid grid-cols-2 md:grid-cols-4 gap-8 p-10 md:p-14">
            {stats.map((s, i) => (
              ...
              >
                ...
                <div className="text-[10px] tracking-[0.2em] uppercase text-muted-foreground/60 mt-2.5 font-semibold font-heading">
                  {s.label}
                </div>
              </motion.div>
            ))}
      ...
      <section
        id="features"
        className="relative z-10 px-6 lg:px-16 xl:px-24 py-32 lg:py-40 max-w-[1400px] mx-auto"
      >
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
        ...
        >
          ...
          <p className="text-muted-foreground/70 mt-6 max-w-xl mx-auto text-lg leading-relaxed">
            Purpose-built tools with real-time analytics and intelligent
            automation for enterprise workforce management.
          </p>
        </motion.div>
                ...
                >
                  ...
                  <div className="relative z-10">
                    <div className="flex items-start justify-between mb-8">
                      <div
                        className={`w-16 h-16 rounded-2xl ${a.iconBg} flex items-center justify-center group-hover:scale-110 transition-transform duration-500 border border-current/5`}
                      >
                        <f.icon size={28} className={a.iconColor} />
                      </div>
                      <div className="text-right">
                        <div
                          className={`text-3xl font-black font-heading ${a.metricColor}`}
                        >
                          {f.metric}
                        </div>
                        <div className="text-[9px] tracking-[0.2em] uppercase text-muted-foreground/50 font-semibold">
                          {f.metricLabel}
                        </div>
                      </div>
                    </div>
                    <h3 className="text-xl font-bold tracking-heading mb-3 font-heading">
                      {f.title}
                    </h3>
                    ...
                    <div className="space-y-2.5">
                      {f.items.map((item) => (
                        ...
                        >
                          <CheckCircle
                            size={14}
                            className={`flex-shrink-0 ${a.iconColor}`}
                          />
                          <span>{item}</span>
                        </div>
                      ))}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {capabilities.map((c, i) => (
            ...
            >
              ...
              <div>
                <h4 className="text-sm font-bold font-heading mb-1">
                  {c.title}
                </h4>
      ...
      <section className="relative z-10 px-6 lg:px-16 xl:px-24 pb-32 lg:pb-40 max-w-[1400px] mx-auto">
        ...
        >
          ...
          <p className="text-muted-foreground/60 mt-5 max-w-lg mx-auto text-lg">
            Tailored experiences for guides, supervisors, managers, and
            administrators.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6 lg:gap-8">
          {roles.map((r, i) => {
            ...
            return (
              ...
              >
                <div
                  className={`w-16 h-16 rounded-2xl ${colors.bg} flex items-center justify-center mb-7 border border-current/5`}
                >
                  <r.icon size={28} className={colors.text} />
                </div>
                <h3 className="text-2xl font-black tracking-heading mb-3 font-heading">
                  {r.role}
                </h3>
                ...
                <ul className="space-y-3.5 mt-auto">
                  {r.items.map((item) => (
                    ...
                    >
                      <CheckCircle
                        size={15}
                        className="text-success/70 flex-shrink-0"
                      />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
          {testimonials.map((t, i) => (
            ...
            >
              ...
              <p className="text-sm text-muted-foreground/70 leading-relaxed mb-7 italic">
                "{t.text}"
              </p>
          ...
          <div className="relative text-center p-14 md:p-24">
            ...
            <div className="relative z-10">
              ...
              <p className="text-muted-foreground/60 mt-6 max-w-lg mx-auto text-lg">
                Start managing leaves, shrinkage, schedules, and approvals with
                data-driven precision across every role. No credit card
                required.
              </p>
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-12">
                <Link
                  to="/login"
                  className="btn-primary-gradient text-primary-foreground font-bold px-14 py-5 rounded-2xl text-base inline-flex items-center gap-3 group shadow-2xl shadow-primary/25"
                >
                  Get Started Free
                  <ArrowUpRight
                    size={18}
        ...
        <div className="max-w-[1400px] mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-primary/15 to-accent/8 flex items-center justify-center border border-primary/10">
              <span className="text-sm font-black gradient-text font-heading">
                L
              </span>
            </div>
            <div>
