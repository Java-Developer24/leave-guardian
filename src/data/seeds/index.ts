  ...
  leaves.push(
    ...
    },
    {
      ...
      history: [
        ...
        { at: '2026-04-01T10:00:00.000Z', by: 'sup1', action: 'Approved', note: 'Approved for April schedule' },
      ],
    },
    {
      id: 'l9017',
      ...
      history: [
        ...
        { at: '2026-04-01T11:00:00.000Z', by: 'sup1', action: 'Approved', note: 'Balanced with the weekend roster' },
      ],
    },
    {
      id: 'l9018',
    ...
    },
    {
      ...
      status: 'PendingSupervisor',
      history: [
        { at: '2026-04-01T06:45:00.000Z', by: 'sup1', action: 'Submitted', note: 'Supervisor initiated transfer request' },
        { at: '2026-04-01T07:15:00.000Z', by: 'a6', action: 'Accepted by Peer', note: 'Buddy accepted transfer' },
      ],
    },
    {
      id: 'l9020',
      ...
      status: 'PendingSupervisor',
      history: [
        { at: '2026-04-01T07:30:00.000Z', by: 'a5', action: 'Submitted', note: 'Swap raised for April roster' },
        { at: '2026-04-01T09:15:00.000Z', by: 'a2', action: 'Accepted by Peer', note: 'Okay to swap leave dates' },
      ],
    },
    {
      id: 'l9021',
      ...
      history: [
        ...
        { at: '2026-04-01T12:00:00.000Z', by: 'sup1', action: 'Approved', note: 'Approved within April quota' },
      ],
    },
    {
      id: 'l9022',
    ...
    },
    {
      ...
      status: 'PendingSupervisor',
      history: [
        { at: '2026-04-01T10:15:00.000Z', by: 'sup1', action: 'Submitted', note: 'Supervisor initiated May transfer' },
        { at: '2026-04-01T10:45:00.000Z', by: 'a2', action: 'Accepted by Peer', note: 'Available to cover transfer' },
      ],
    },
    {
      id: 'l9024',
      ...
      history: [
        ...
        { at: '2026-04-01T11:30:00.000Z', by: 'sup1', action: 'Approved', note: 'Approved for swap availability' },
      ],
    },
    {
      id: 'l9025',
      ...
      history: [
        ...
        { at: '2026-04-02T11:10:00.000Z', by: 'sup1', action: 'Approved', note: 'Approved with shift coverage in place.' },
      ],
    },
    {
      id: 'l9026',
    ...
    },
    {
      ...
      history: [
        ...
        { at: '2026-04-02T12:05:00.000Z', by: 'sup1', action: 'Approved', note: 'Approved for May schedule.' },
      ],
    },
    {
      id: 'l9028',
    ...
    },
    {
      ...
      history: [
        ...
        { at: '2026-04-02T12:30:00.000Z', by: 'sup1', action: 'Approved', note: 'Approved and aligned with May roster.' },
      ],
    },
    {
      id: 'l9030',
      ...
      history: [
        ...
        { at: '2026-04-02T13:00:00.000Z', by: 'sup1', action: 'Approved', note: 'Approved to support May transfer planning.' },
      ],
    },
  );
...
export const seedWeekoffSwapRequests: WeekoffSwapRequest[] = [
  {
    ...
    monthKey: '2026-04',
    status: 'PendingAdmin',
    comment: 'Swap the full April week-off pattern to balance coaching coverage.',
    history: [
      { at: '2026-04-01T08:30:00.000Z', by: 'sup1', action: 'Submitted', note: 'Swap the full April week-off pattern to balance coaching coverage.' },
    ],
  },
  {
    id: 'ws2',
    ...
    history: [
      { at: '2026-04-01T07:10:00.000Z', by: 'sup1', action: 'Submitted', note: 'Moved the week off from Sunday to Saturday for an appointment.' },
      { at: '2026-04-01T09:00:00.000Z', by: 'admin1', action: 'Approved', note: 'Validated and published to schedule.' },
    ],
  },
  {
    id: 'ws3',
    ...
    history: [
      { at: '2026-04-01T07:45:00.000Z', by: 'sup1', action: 'Submitted', note: 'Swapped the current week off between both guides.' },
      { at: '2026-04-01T09:20:00.000Z', by: 'admin1', action: 'Approved', note: 'Approved for current-week coverage.' },
    ],
  },
  {
    id: 'ws4',
    ...
    monthKey: '2026-04',
    status: 'Approved',
    comment: 'Swapped the repeating April week-off pattern between both guides.',
    history: [
      { at: '2026-04-02T08:05:00.000Z', by: 'sup1', action: 'Submitted', note: 'Swapped the repeating April week-off pattern between both guides.' },
      { at: '2026-04-02T10:15:00.000Z', by: 'admin1', action: 'Approved', note: 'Approved after reviewing the monthly roster impact.' },
    ],
  },
  {
    id: 'ws5',
    ...
    history: [
      { at: '2026-04-18T07:55:00.000Z', by: 'sup1', action: 'Submitted', note: 'Moved the guide week off to Saturday for a training overlap.' },
      { at: '2026-04-18T10:05:00.000Z', by: 'admin1', action: 'Approved', note: 'Approved after week-level validation.' },
    ],
  },
  {
    id: 'ws6',
    ...
    history: [
      { at: '2026-04-03T08:20:00.000Z', by: 'sup1', action: 'Submitted', note: 'Swap the last week-off of April to cover end-of-month coaching.' },
    ],
  },
  {
    id: 'ws7',
    ...
    history: [
      { at: '2026-04-22T09:00:00.000Z', by: 'sup1', action: 'Submitted', note: 'Approved a same-week swap for May launch support coverage.' },
      { at: '2026-04-22T12:10:00.000Z', by: 'admin1', action: 'Approved', note: 'Approved for launch week support.' },
    ],
  },
  {
    id: 'ws8',
    ...
    history: [
      { at: '2026-04-04T08:00:00.000Z', by: 'sup1', action: 'Submitted', note: 'Moved the off day to keep floor coverage stable during coaching.' },
      { at: '2026-04-04T11:15:00.000Z', by: 'admin1', action: 'Approved', note: 'Approved after validating weekly balance.' },
    ],
  },
  {
    id: 'ws9',
    ...
    history: [
      { at: '2026-04-25T09:10:00.000Z', by: 'sup1', action: 'Submitted', note: 'Approved current-week swap to protect the weekend queue.' },
      { at: '2026-04-25T12:00:00.000Z', by: 'admin1', action: 'Approved', note: 'Approved because the weekend coverage remained safe.' },
    ],
  },
  {
    id: 'ws10',
    ...
    monthKey: '2026-05',
    status: 'Approved',
    comment: 'Swapped the regular May week-off pattern for training continuity.',
    history: [
      { at: '2026-04-26T08:40:00.000Z', by: 'sup1', action: 'Submitted', note: 'Swapped the regular May week-off pattern for training continuity.' },
      { at: '2026-04-26T11:20:00.000Z', by: 'admin1', action: 'Approved', note: 'Approved after checking the full month availability.' },
    ],
  },
  {
    id: 'ws11',
    ...
    history: [
      { at: '2026-04-27T07:50:00.000Z', by: 'sup1', action: 'Submitted', note: 'Queued for admin review before the last May coaching week.' },
    ],
  },
];
